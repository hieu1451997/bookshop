	            ...
	            <div class=" form">
	                ...
	                <form class="cmxform form-horizontal " id="commentForm" method="post" action="{{ URL::to('/update-product/'.$edit_pro->product_id) }}" novalidate="novalidate" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
	                        ...
	                        <div class="col-lg-6">
	                            <input class=" form-control" id="cname" name="product_price" minlength="2" type="number" required="" value="{{$edit_pro->product_price}}">
	                        </div>
	                    </div>
	                    <div class="form-group ">
	                        <label for="cname" class="control-label col-lg-3">Số lượng</label>
	                        <div class="col-lg-6">
	                            <input class=" form-control" id="cname" name="product_quantity" minlength="2" type="number" required="" value="{{$edit_pro->product_quantity}}">
	                        </div>
	                    </div>
	                     <div class="form-group">
