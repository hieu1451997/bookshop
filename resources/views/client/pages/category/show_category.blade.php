                ...
                <div class="col-lg-12">
                    <div class="bradcaump__inner text-center">
                        @foreach($category as $key => $val)
                            <h2 class="bradcaump-title">{{$val->category_product_name}}</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="{{URL::to('/')}}">Trang chủ</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">{{$val->category_product_name}}</span>
                            </nav>
                        @endforeach
                    </div>
                </div>
                    ...
                    <div class="tab__container">
                        <div class="shop-grid tab-pane fade show active" id="nav-grid" role="tabpanel">
                            <div class="row">
                                ...
                                @foreach($all_product_by_category as $key => $pro)
