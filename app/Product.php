...
class Product extends Model
{
    ...
    protected $fillable = ['category_product_id','publisher_id','product_name','product_content','product_desc','product_price','product_quantity','product_image','product_status'];
